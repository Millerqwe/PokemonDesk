!(function (e) {
  ...
  function (e, t, n) {
    ...
    function i(e, t) {
      for (var n = {}, r = [], l = 0; l < e.length; l++) {
        ...
        -1 !== f ? (o[f].references++, o[f].updater(d)) : o.push({ identifier: s, updater: v(d, t), references: 1 }),
          r.push(s);
      }
      return r;
    }
    ...
    function v(e, t) {
      ...
      if (t.singleton) {
        var a = m++;
        (n = h || (h = c(t))), (r = d.bind(null, n, a, !1)), (l = d.bind(null, n, a, !0));
      } else
        (n = c(t)),
          (r = p.bind(null, n, t)),
          (l = function () {
  ...
  function (e, t, n) {
    ...
    o.push([
      e.i,
      '.App-module--text--dHpf{font-size:30px}',
      '',
      {
        version: 3,
        sources: ['webpack://src/App.module.scss'],
        names: [],
        mappings: 'AAAA,wBACE,cAAA',
        sourcesContent: ['.text {\r\n  font-size: 30px;\r\n}\r\n'],
        sourceRoot: '',
      },
    ]),
      (o.locals = { text: 'App-module--text--dHpf' }),
      (t.a = o);
  },
  function (e, t, n) {
    'use strict';
    ...
    o.push([
      ...
      '',
      {
        ...
        names: [],
        mappings: 'AAAA;EACE,kBAAkB;EAClB,uBAAuB;AACzB',
        sourcesContent: ['body {\r\n  text-align: center;\r\n  background-color: azure;\r\n}'],
        sourceRoot: '',
      },
    ]),
...
*/ var r = Object.getOwnPropertySymbols,
  ...
  function (e, t, n) {
    ...
    var l = r(n(3)),
      a = r(n(9)),
      o = n(13);
    n(16), a.default.render(l.default.createElement(o.App), document.querySelector('.root'));
  },
  function (e, t, n) {
    'use strict';
  ...
  function (e, t, n) {
        ...
        e: {
          ...
          if (void 0 !== u) {
            ...
            for (var p, h = r; null !== h; ) {
              var m = (p = h).stateNode;
              if (
                (5 === p.tag && null !== m && ((p = m), null !== d && null != (m = Ue(h, d)) && s.push(Lr(h, m, p))), f)
              )
                break;
              h = h.return;
            }
    ...
    function Or(e, t) {
      for (var n = t + 'Capture', r = []; null !== e; ) {
        ...
        5 === l.tag &&
          null !== a &&
          ((l = a), null != (a = Ue(e, n)) && r.unshift(Lr(e, a, l)), null != (a = Ue(e, t)) && r.push(Lr(e, a, l))),
          (e = e.return);
      }
      return r;
    }
    ...
    function Rr(e, t, n, r, l) {
      for (var a = t._reactName, o = []; null !== n && n !== r; ) {
        ...
        5 === u.tag &&
          null !== c &&
          ((u = c),
          l ? null != (i = Ue(n, a)) && o.unshift(Lr(n, i, u)) : l || (null != (i = Ue(n, a)) && o.push(Lr(n, i, u)))),
          (n = n.return);
      }
    ...
    function wa(e) {
      ...
      function i(e, t, n, r) {
        return null === t || 6 !== t.tag ? (((t = $i(n, e.mode, r)).return = e), t) : (((t = l(t, n)).return = e), t);
      }
      function c(e, t, n, r) {
        return null !== t && t.elementType === n.type
          ? (((r = l(t, n.props)).ref = ya(e, t, n)), (r.return = e), r)
          : (((r = ji(n.type, n.key, n.props, null, e.mode, r)).ref = ya(e, t, n)), (r.return = e), r);
      }
      function s(e, t, n, r) {
        return null === t ||
          4 !== t.tag ||
      ...
      function d(e, t, n) {
        ...
        if ('object' == typeof t && null !== t) {
          switch (t.$$typeof) {
            case S:
              return ((n = ji(t.type, t.key, t.props, null, e.mode, n)).ref = ya(e, null, t)), (n.return = e), n;
            case E:
              return ((t = Hi(t, e.mode, n)).return = e), t;
          }
          if (ga(t) || V(t)) return ((t = Bi(t, e.mode, n, null)).return = e), t;
          ba(e, t);
        }
        return null;
      }
            ...
            case S:
              e: {
                    ...
                    switch (c.tag) {
                      ...
                      default:
                        if (c.elementType === a.type) {
                          n(e, c.sibling), ((r = l(c, a.props)).ref = ya(e, c, a)), (r.return = e), (e = r);
                          break e;
                        }
                    }
                    n(e, c);
                ...
                a.type === x
                  ...
                  : (((i = ji(a.type, a.key, a.props, null, e.mode, i)).ref = ya(e, r, a)), (i.return = e), (e = i));
              }
              return u(e);
            case E:
              e: {
        ...
        if (t) {
          ...
          if (!Aa(e, t)) {
            if (!(t = $r(n.nextSibling)) || !Aa(e, t))
              return (e.flags = (-1025 & e.flags) | 2), (Da = !1), void (Ra = e);
            Fa(Ra, n);
          }
    ...
    function Ba(e) {
      ...
      if (5 !== e.tag || ('head' !== t && 'body' !== t && !Ur(t, e.memoizedProps)))
        for (t = Ia; t; ) Fa(e, t), (t = $r(t.nextSibling));
      if ((ja(e), 13 === e.tag)) {
    ...
    function to(e, t, n, r, l, a) {
      if (
        ...
        do {
          ...
          (a += 1), (Xa = Ya = null), (t.updateQueue = null), (Wa.current = zo), (e = n(r, l));
        } while (Ja);
      }
      if (((Wa.current = Po), (t = null !== Ya && null !== Ya.next), (qa = 0), (Xa = Ya = Ka = null), (Ga = !1), t))
        throw Error(o(300));
      return e;
    }
    function no() {
    ...
    function uo(e, t, n) {
      ...
      if (
        (null !== l
          ? (e = l === r)
          : ((e = e.mutableReadLanes), (e = (qa & e) === e) && ((t._workInProgressVersionPrimary = r), $a.push(t))),
        e)
      )
        return n(t._source);
              ...
              : ((r = null !== r),
                ...
                r &&
                  ...
                  ((null === e && !0 !== t.memoizedProps.unstable_avoidThisFallback) || 0 != (1 & Oa.current)
                    ? 0 === Lu && (Lu = 3)
                    : ((0 !== Lu && 3 !== Lu) || (Lu = 4),
                      null === Cu || (0 == (134217727 & Ru) && 0 == (134217727 & Iu)) || fi(Cu, Nu))),
                (r || n) && (t.flags |= 4),
                null)
          );
        case 4:
        ...
        case 19:
          ...
          if (((u = 0 != (64 & t.flags)), null === (c = r.rendering)))
            if (u) tu(r, !1);
              ...
              null !== r.tail && Al() > Uu && ((t.flags |= 64), (u = !0), tu(r, !1), (t.lanes = 33554432));
            }
          else {
            if (!u)
              if (null !== (e = Ma(c))) {
                if (
                  ...
                  tu(r, !0),
                  null === r.tail && 'hidden' === r.tailMode && !c.alternate && !Da)
                )
                  return null !== (t = t.lastEffect = r.lastEffect) && (t.nextEffect = null), null;
              } else
                2 * Al() - r.renderingStartTime > Uu &&
                  1073741824 !== n &&
    ...
    function ru(e) {
      switch (e.tag) {
        ...
        case 3:
          if ((Ta(), al(cl), al(il), Ha(), 0 != (64 & (t = e.flags)))) throw Error(o(285));
    ...
    function iu(e, t, n) {
      ...
      return (
        null !== a &&
          ...
          (n.callback = function () {
            'function' != typeof r && (null === Wu ? (Wu = new Set([this])) : Wu.add(this), au(0, t));
            var e = t.stack;
    ...
    function bu(e, t) {
      switch (t.tag) {
        ...
        case 12:
          return;
        case 13:
          return null !== t.memoizedState && ((Au = Al()), pu(t.child, !0)), void wu(t);
        case 19:
          return void wu(t);
        case 17:
          return;
    ...
    var Bu,
      ...
      li = !1;
    function ai() {
      return 0 != (48 & _u) ? Al() : -1 !== ei ? ei : (ei = Al());
    }
    function oi(e) {
    ...
    function ci(e, t) {
      ...
      if (((r = Ft(e, e === Cu ? Nu : 0)), (t = It), 0 === r))
        ...
        15 === t
          ? ((n = di.bind(null, e)), null === Rl ? ((Rl = [n]), (Il = kl(Pl, Hl))) : Rl.push(n), (n = Ol))
          : 14 === t
    ...
    function si(e) {
      ...
      if ((Gl(), (Eu.current = a), (_u = l), null !== Pu ? (r = 0) : ((Cu = null), (Nu = 0), (r = Lu)), 0 != (Mu & Iu)))
        gi(e, 0);
      else if (0 !== r) {
        if (
          (2 === r &&
            ((_u |= 64), e.hydrate && ((e.hydrate = !1), Vr(e.containerInfo)), 0 !== (n = At(e)) && (r = wi(e, n))),
          1 === r)
        )
          throw ((t = Ou), gi(e, 0), fi(e, n), ci(e, Al()), t);
        switch (((e.finishedWork = e.current.alternate), (e.finishedLanes = n), r)) {
          ...
          case 2:
            ...
            break;
          case 3:
            if ((fi(e, n), (62914560 & n) === n && 10 < (r = Au + 500 - Al()))) {
              if (0 !== Ft(e, 0)) break;
      ...
      return ci(e, Al()), e.callbackNode === t ? si.bind(null, e) : null;
    }
    function fi(e, t) {
    ...
    function di(e) {
      ...
      if (
        (0 !== e.tag &&
          2 === n &&
          ((_u |= 64), e.hydrate && ((e.hydrate = !1), Vr(e.containerInfo)), 0 !== (t = At(e)) && (n = wi(e, t))),
        1 === n)
      )
        throw ((n = Ou), gi(e, 0), fi(e, t), ci(e, Al()), n);
      return (e.finishedWork = e.current.alternate), (e.finishedLanes = t), _i(e), ci(e, Al()), null;
    }
    function pi(e, t) {
      var n = _u;
      _u |= 1;
    ...
    function gi(e, t) {
      ...
      (Cu = e), (Pu = Ui(e.current, null)), (Nu = Tu = Mu = t), (Lu = 0), (Ou = null), (Du = Iu = Ru = 0);
    }
    function yi(e, t) {
      for (;;) {
        var n = Pu;
                ...
                case 1:
                  ...
                  if (
                    ...
                    ('function' == typeof k.getDerivedStateFromError ||
                      (null !== S && 'function' == typeof S.componentDidCatch && (null === Wu || !Wu.has(S))))
                  ) {
    ...
    function Ci(e, t) {
      ...
      if (
        ...
        if (((l = _u), (_u |= 32), (xu.current = null), (Dr = Kt), dr((u = fr())))) {
          if ('selectionStart' in u) i = { start: u.selectionStart, end: u.selectionEnd };
            ...
            e: if (
              ...
              t: for (;;) {
                ...
                for (;;) {
                  if (v === u) break t;
                  if ((g === i && ++h === a && (d = f), g === c && ++m === s && (p = f), null !== (y = v.nextSibling)))
                    break;
                  g = (v = g).parentNode;
                }
                v = y;
        ...
        (Fr = { focusedElem: u, selectionRange: i }), (Kt = !1), (ri = null), (li = !1), (Vu = r);
        do {
          try {
            Pi();
          } catch (e) {
        ...
        (Kt = !!Dr), (Fr = Dr = null), (e.current = n), (Vu = r);
        do {
          try {
            for (b = e; null !== Vu; ) {
              var E = Vu.flags;
      ...
      if ((ci(e, Al()), $u)) throw (($u = !1), (e = Hu), (Hu = null), e);
        ...
        for (var n = e.return; null !== n; ) {
          ...
          if (1 === n.tag) {
            ...
            if (
              ...
              else if ('function' == typeof r.componentDidCatch && (null === Wu || !Wu.has(r)))
                try {
    ...
    function Ri(e, t, n) {
      ...
      null !== r && r.delete(t),
        ...
        Cu === e &&
          (Nu & n) === n &&
          (4 === Lu || (3 === Lu && (62914560 & Nu) === Nu && 500 > Al() - Au) ? gi(e, 0) : (Du |= n)),
        ci(e, t);
    }
    function Ii(e, t) {
      var n = e.stateNode;
      ...
      if (((r = e), 'function' == typeof e)) Ai(e) && (u = 1);
        ...
        e: switch (e) {
          ...
          case F:
            return Vi(n, l, a, t);
          case A:
            return ((e = Fi(24, n, t, l)).elementType = A), (e.lanes = a), e;
          default:
          ...
          if (
            ...
            if (
              ((a = (l = t.stateNode).hydrate) &&
                ((Ia = $r(t.stateNode.containerInfo.firstChild)), (Ra = t), (a = Da = !0)),
              a)
            ) {
    ...
    (t.unstable_IdlePriority = 5),
      ...
      (t.unstable_scheduleCallback = function (e, n, o) {
        ...
        return (
          ...
          o > u
            ? ((e.sortIndex = o), E(N, e), null === x(P) && e === x(N) && (R ? a() : (R = !0), l(D, o - u)))
  ...
  function (e, t, n) {
    ...
    t.App = function () {
      return l.default.createElement(
        'div',
        { className: a.default(o.default.text, 'text--opacity') },
